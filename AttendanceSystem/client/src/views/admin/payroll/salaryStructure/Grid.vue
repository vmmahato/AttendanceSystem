...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteItem({allowanceID, designationName}) {
                this.snackbar.dialog = true
                this.snackbar.deleteForm = true
                this.snackbar.deleteUrl = 'Allowances/DeleteAllowances/' + allowanceID
                this.snackbar.deleteItemTitle = 'Settlement  ' + '   ' + designationName
            },
            createItem() {
                this.snackbar.dialog = true
            ...
            async loadItems() {
                ...
                let param = {
                    ...
                    OrderBy: sortBy[0],
                    AllowanceName: this.filterParams.designationName,
                }
                try {
