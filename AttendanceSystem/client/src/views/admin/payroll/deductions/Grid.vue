    ...
    export default {
        ...
        methods: {
            editItem({deductionID}) {
                ...
                this.snackbar.getItemUrl = 'Deductions/GetDeductionsByID/' + deductionID
            },
            deleteItem({deductionID, deductionName}) {
                this.snackbar.dialog = true
                this.snackbar.deleteForm = true
                this.snackbar.deleteUrl = 'Deductions/DeleteDeductions/' + deductionID
                this.snackbar.deleteItemTitle = 'Settlement  ' + '   ' + deductionName
            },
            createItem() {
                this.snackbar.dialog = true
            ...
            async loadItems() {
                ...
                let param = {
                    ...
                    OrderBy: sortBy[0],
                    DeductionName: this.filterParams.deductionName,
                }
                try {
                    const {data} = await axios.post("Deductions/DeductionsList", param)
                    this.rows = data.data;
