<template>
    <v-card class="customFontSize">
        <v-card-title>
            <span class="headline">Edit Kaj</span>
        </v-card-title>
        ...
        <v-card-actions>
            ...
            <v-btn color="teal darken-1" text @click="saveData" v-if="isPending">Save</v-btn>
        </v-card-actions>
    </v-card>
</template>
    ...
    export default {
        ...
        computed: {
            ...
            officeVisitErrors() {
                ...
                !this.$v.formData.officeVisit.required && errors.push('Kaj is required.')
                return errors
            },
            fromDateErrors() {
                const errors = []
        ...
        methods: {
            ...
            async saveData() {
                ...
                if (this.$v.$invalid) {
                    ...
                    try {
                        const {data} = await axios.post('Kaj/UpdateKaj', this.formData)
