...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteItem({kajID, employeeName}) {
                this.snackbar.dialog = true
                this.snackbar.deleteForm = true
                this.snackbar.deleteUrl = 'Kaj/DeleteKaj/' + kajID
                this.snackbar.deleteItemTitle = 'Kaj ' + ' for  ' + employeeName
            },
            createItem() {
                this.snackbar.dialog = true
            ...
            async loadItems() {
                ...
                let param = {
                    ...
                    OrderBy: sortBy[0],
                    Kaj: this.filterParams.officeVisit,
                }
                try {
