<template>
    <v-card class="customFontSize">
        <v-card-title>
            ...
            <v-spacer></v-spacer>
            <!--<v-btn depressed  text @click="closeForm" id="closeBTN">
            ...
            async saveData() {
                ...
                if (this.$v.$invalid) {
                    ...
                    try {
                        ...
                        const {data} = await axios.post('Employee/InsertIntoEmployeeAsync', form_data)
                        this.snackbar.message = data.success ? 'Employee Created Successfully' : data.errors.join(', ')
