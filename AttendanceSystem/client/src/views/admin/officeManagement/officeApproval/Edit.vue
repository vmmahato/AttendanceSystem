<template>
    <v-card class="text-left">
        <v-card-title>
            <span class="headline"> Office Visit Approval</span>
            <v-spacer></v-spacer>
                ...
                <v-row>
                        ...
                        <v-list three-line subheader>
                            <v-list-item >
                                <v-list-item-content>
                                    ...
                                    <v-list-item-subtitle>{{formData.fromDate}} {{' '}} {{formData.fromTime}}</v-list-item-subtitle>
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
                    </v-col>
                        ...
                        <v-list three-line subheader>
                            <v-list-item >
                                <v-list-item-content>
                                    ...
                                    <v-list-item-subtitle>{{formData.toDate}} {{' '}} {{formData.toTime}}</v-list-item-subtitle>
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
                    </v-col>
                    ...
                    <v-col cols="12" md="6">
                        <v-list three-line subheader>
                            <v-list-item >
                                <v-list-item-content>
                                    <v-list-item-title>Visitors Name</v-list-item-title>
                                    <v-list-item-subtitle>{{formData.visitorName}}</v-list-item-subtitle>
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
                    </v-col>
    ...
    export default {
        ...
        methods: {
            ...
            async saveData(status) {
                    try {
                        const { officeVisitID } = this.formData
                        let params = {
                            officeVisitID,
                            status
                        }
                        const {data} = await axios.post('OfficeVisit/UpdatePendingOfficeVisit', params)
