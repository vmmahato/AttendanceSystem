                ...
                <v-row>
                    ...
                    <v-col cols="12" md="6">
                        <div id="preview" style="width: 200px">
                            <v-img :src="imageURL || formData.companyImageURL" alt="Upload Image"/>
                        </div>
...
<script>
    import {required, email, helpers, maxLength, minLength, numeric} from "vuelidate/lib/validators";
            ...
            async saveData() {
                ...
                if (this.$v.$invalid) {
                    ...
                    try {
                        ...
                        const {data} = await axios.post('CompanyProfile/UpdateCompanyProfile', form_data)
                        this.snackbar.message = data.success ? 'Company Updated Successfully' : data.errors.join(', ')
