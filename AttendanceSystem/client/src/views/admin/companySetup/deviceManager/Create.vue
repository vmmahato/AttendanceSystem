        ...
        methods: {
            ...
            async saveData() {
                ...
                if (this.$v.$invalid) {
                    ...
                    try {
                        const {data} = await axios.post('Device/CreateDevice', this.formData)
                        this.snackbar.message = data.success ? 'Device Created Successfully' : data.errors.join(', ')
