...
<script>
    ...
    export default {
        ...
        methods: {
            editItem({userRolesID}) {
                this.snackbar.dialog = true
                this.snackbar.editForm = true
                this.snackbar.getItemUrl = 'UserRoles/GetUserRolesByIDAsync?UserRoleID=' + userRolesID
            },
            deleteItem({userRolesID, firstName, lastName}) {
                this.snackbar.dialog = true
                this.snackbar.deleteForm = true
                this.snackbar.deleteUrl = 'UserRoles/DeleteUserRolesAsync/' + userRolesID
                this.snackbar.deleteItemTitle = 'User Role ' + '   ' + firstName + '' + lastName
            },
            createItem() {
                this.snackbar.dialog = true
            ...
            async loadItems() {
                ...
                try {
                    const {data} = await axios.post("UserRoles/UserRolesListAsync", param)
                    this.rows = data.data;
